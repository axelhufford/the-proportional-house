...
{rows}    </tbody>
  ...
  <p>It also reflects something the map keeps showing: Democratic voters cluster in cities, so the party
    piles up big margins in a few districts and &ldquo;wastes&rdquo; a lot of votes. By 2018 several of
    those maps had been struck down or handed to independent commissions (including Pennsylvania and
    Michigan), and a strong Democratic year turned votes into seats more efficiently. The maps used in
    2022 and 2024 are close to nationally balanced, because new Democratic gerrymanders (Illinois) and
