...
const FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    a: 'The Sandbox is the interactive part of the site — a what-if calculator. The Current and 2024 Retrospective views each show one computed outcome; the Sandbox lets you change the assumptions and watch every state\'s projected delegation, the national totals, and the map all recompute on the fly. Three knobs: a hypothetical generic-ballot slider (from R+15 to D+15), up to three minor parties (preset coalitions or fully custom), and an allocation method (Pure PR, multi-member districts, or mixed-member proportional). A comparison table at the bottom shows national seat totals under every allocation method side-by-side. Every Sandbox setting is captured in the URL, so any scenario you build is a sharable link.',
  },
  {
